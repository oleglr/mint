      ...
      {config?.topbarCtaButton && (
        <li>
          <Link href={config.topbarCtaButton.url}>
            <a
              target="_blank"
              className="relative inline-flex items-center space-x-1 px-4 py-1 border border-transparent shadow-sm text-sm font-medium rounded-[0.3rem] text-white bg-primary-dark hover:bg-primary-ultradark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-primary-light"
            >
